...
class FCISInstanceSegmentationAnnotator : public DrawingAnnotator
{
private:
  struct ObjectMask
  {
...
public:
  ...
  FCISInstanceSegmentationAnnotator(): DrawingAnnotator(__func__) {}
...
MAKE_AE(FCISInstanceSegmentationAnnotator)
