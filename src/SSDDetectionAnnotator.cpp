...
class SSDDetectionAnnotator : public DrawingAnnotator
{
private:
...
public:
  ...
  SSDDetectionAnnotator(): DrawingAnnotator(__func__) {}
  ...
  TyErrorId initialize(AnnotatorContext &ctx)
  {
    ...
    predictor = rs_addons_module.attr("SSDDetectionPredictor")
