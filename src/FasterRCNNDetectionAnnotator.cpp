...
class FasterRCNNDetectionAnnotator : public DrawingAnnotator
{
private:
...
public:
  ...
  FasterRCNNDetectionAnnotator(): DrawingAnnotator(__func__) {}
  ...
  TyErrorId initialize(AnnotatorContext &ctx)
  {
    ...
    predictor = rs_addons_module.attr("FasterRCNNDetectionPredictor")
...
MAKE_AE(FasterRCNNDetectionAnnotator)
